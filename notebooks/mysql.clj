...
;; XXX "UTC" 로 했을 때는
;;   전부 LocalDateTime 으로 2020-01-01 10:10:10 이 나올 거라 기대하고 있다.
;; XXX "Asia/Seoul" 로 했을 때도
;;   전부 LocalDateTime 으로 2020-01-01 10:10:10 이 나올 거라 기대하고 있다.
...
;; select 했을 때
;; XXX Asia/Seoul 은
;;   1. java.sql.Timestamp 로 2020-01-01 10:10:10+09:00 의 instant 로
;;   2. java.sql.Timestamp 로 2020-01-01 10:10:10+09:00 의 instant 로
;;   3. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;   4. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;   5. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;
;; 나오기를 기대한다.
;;
;; XXX UTC 는
;;   1. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;   2. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;   3. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;   4. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;   5. java.sql.Timestamp 로 2020-01-01 10:10:10+00:00 의 instant 로
;;
...
;; mysql 에서 timezone offset 이 붙은 리터럴을 8.0.19 부터 지원하기 시작했다. 이것은 jdbc 의
;; prepared statement 와 처리와 연관된 것이 있을까?
...
;; mysql 의 datetime, timestamp 는 무엇인가?
;;
